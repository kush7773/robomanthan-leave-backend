...
export class MailService {
  ...
  async sendLeaveRequestToApprover(data: {
    ...
    const approveLink = `${process.env.API_BASE_URL}/leaves/approve?token=${data.approvalToken}`;
    const rejectLink = `${process.env.API_BASE_URL}/leaves/reject?token=${data.approvalToken}`;
